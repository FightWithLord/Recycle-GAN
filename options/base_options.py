...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--npf', type=int, default=8, help='# of pred filters in first conv layer')
        ...
        self.parser.add_argument('--which_model_netP', type=str, default='prediction',
                                 help='selects model to use for netG')
